        ...
        <a-tab-pane key="1" type="card">
          ...
          <a-radio-group v-model="result.second.cronEvery">
            ...
            <a-row>
              <a-radio value="4">
                周期从
                <a-input-number :max="59" :min="1" size="small" v-model="result.second.rangeStart"></a-input-number>到
                <a-input-number :max="59" :min="0" size="small" v-model="result.second.rangeEnd"></a-input-number>秒
              </a-radio>
            </a-row>
          </a-radio-group>
        </a-tab-pane>
            ...
            <a-radio-group v-model="result.minute.cronEvery">
              ...
              <a-row>
                <a-radio value="4">
                  ...
                  ></a-input-number>到
                  <a-input-number :max="59" :min="0" size="small" v-model="result.minute.rangeEnd"></a-input-number>分
                </a-radio>
              </a-row>
            </a-radio-group>
          </div>
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.hour.cronEvery">
              ...
              <a-row>
                ...
                >
                  <a-select-option :key="index" v-for="(val,index) in Array(24)">{{ index }}</a-select-option>
                </a-select>
              </a-row>
              <a-row>
                <a-radio value="4">
                  周期从
                  <a-input-number :max="23" :min="0" size="small" v-model="result.hour.rangeStart"></a-input-number>到
                  <a-input-number :max="23" :min="0" size="small" v-model="result.hour.rangeEnd"></a-input-number>小时
                </a-radio>
              </a-row>
            </a-radio-group>
          </div>
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.month.cronEvery">
              ...
              <a-row>
                <a-radio value="4">
                  从
                  <a-input-number :max="12" :min="1" size="small" v-model="result.month.rangeStart"></a-input-number>到
                  <a-input-number :max="12" :min="1" size="small" v-model="result.month.rangeEnd"></a-input-number>月之间的每个月
                </a-radio>
              </a-row>
            </a-radio-group>
          </div>
